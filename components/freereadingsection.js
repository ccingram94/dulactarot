        ...
        <div className="flex flex-row flex-wrap justify-center p-4 pt-12 bg-black text-black">
          ...
          <Link href="/celticcrosstarotreading">
            <div className="max-w-xs bg-yellow-200 p-6 m-3 flex flex-col justify-center max-w-sm hover:shadow-2xl hover:shadow-yellow-100 transition-all rounded-xl">
              ...
              <p className='text-sm text-center text-yellow-600'>A Celtic Cross reading can give insights into a person's current situation, their hopes and fears, and what may be coming up in their future. It can also reveal the influences of past actions and events, and how they may be affecting the present.</p>
            </div>
          </Link>
        </div>
    </div>
